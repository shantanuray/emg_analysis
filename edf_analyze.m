...
emg_ch1_filtered_rectified = emg_signal_cleanup(emg_ch1);
emg_ch2_filtered_rectified = emg_signal_cleanup(emg_ch2);
emg_ch3_filtered_rectified = emg_signal_cleanup(emg_ch3);
...
emg_ch1_filtered_rectified_samples = emg_select(emg_ch1_filtered_rectified, time_stamp, interval_duration, sampling_frequency);
emg_ch2_filtered_rectified_samples = emg_select(emg_ch2_filtered_rectified, time_stamp, interval_duration, sampling_frequency);
emg_ch3_filtered_rectified_samples = emg_select(emg_ch3_filtered_rectified, time_stamp, interval_duration, sampling_frequency);
...
emg_ch1_filtered_rectified_moving_avg = moving_average(emg_ch1_filtered_rectified_avg, window_duration, sampling_frequency);
emg_ch2_filtered_rectified_moving_avg = moving_average(emg_ch2_filtered_rectified_avg, window_duration, sampling_frequency);
emg_ch3_filtered_rectified_moving_avg = moving_average(emg_ch3_filtered_rectified_avg, window_duration, sampling_frequency);
